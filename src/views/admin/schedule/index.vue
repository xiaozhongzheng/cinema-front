...
import type { SearchParamType, TableParamType } from '@/components/SearchTableTemplate.vue'
...
const searchParamsList = ref<SearchParamType[]>([
  ...
  },
  {
    ...
    type: "select",
    placeholder: "请选择放映厅",
    options: computed(() => screenRoomList.value.map(item => ({
      label: item,
      value: item
    })))
  },
